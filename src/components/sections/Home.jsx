            ...
            >
                ...
                <div className="text-center z-10 px-4 flex flex-col justify-center items-center">
                    ...
                    <div className="flex justify-center gap-4 hover:gap-8 transition-all duration-500">
                        ...
                        <a href={import.meta.env.BASE_URL+"CV.pdf"} download="CV.pdf" className='bg-blue-500/30 text-blue-500 py-3 px-6 rounded font-medium flex items-center gap-x-2 hover:-translate-y-0.5 drop-shadow-xl drop-shadow-blue-500/30 hover:drop-shadow-blue-500/80'>
                        CV
                        <FaDownload />
                        </a>
