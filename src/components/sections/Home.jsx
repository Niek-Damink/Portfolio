    ...
    return <section 
            ...
            >
                ...
                <div className="text-center z-10 px-4 flex flex-col justify-center items-center">
                    <img src={logo} alt="Logo" className="w-70 h-70 mt-5" />
                    ...
                    <div className="flex justify-center gap-4 hover:gap-8 transition-all duration-500">
                        <a href="#about" className="bg-blue-500/30 text-blue-500 py-3 px-6 rounded-l-full font-medium transition flex items-center justify-center  relative overflow-hidden hover:-translate-y-0.5 hover:bg-blue-500/50 hover:shadow-[0_0_15px_rgba(59, 130, 246, 0.4)]">
                            More About Me
                        </a>
                        ...
                        <a href="#contact" className="bg-blue-500/30 text-blue-500 py-3 px-6 rounded-r-full font-medium transition flex items-center justify-center  relative overflow-hidden hover:-translate-y-0.5 hover:bg-blue-500/50 hover:shadow-[0_0_15px_rgba(59, 130, 246, 0.4)]">
                            Contact Me
                        </a>
                    </div>
                </div>
